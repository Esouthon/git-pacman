...
public class Food extends Figure {
	...
	public static final int POWER_UP_SCORE = 100;
	...
	// ci-dessous : deux "constructeurs"
	//on parle de polymorphisme
	// Dans une classe, le constrcuteur peut être implicite
	...
	public Food(int size, int x, int y, boolean isPowerUp) {
		...
		int sg;
		if (this.isPowerUp) {
			sg = size / 2; //les boules PowerUp sont plus grosses !
		} else {
			sg = size / 5;
		}
