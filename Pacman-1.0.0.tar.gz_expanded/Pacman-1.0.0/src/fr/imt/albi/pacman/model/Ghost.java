...
public class Ghost extends Creature {
    ...
    //ci-dessous, des attributs dont les valeurs ne sont pas fixées par défault, 
    //on attribura leurs valeurs au moment de l'instanciation 
    ...
    //on ne définie pas cette méthode car les ghosts ne mangent pas la food
